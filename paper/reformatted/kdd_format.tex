...
% Remove ACM copyright and conference info for anonymous submission
\setcopyright{none}
...
\begin{CCSCONCEPTSTEST}
\ccsdesc[500]{Applied computing~Bioinformatics}
\ccsdesc[300]{Computing methodologies~Machine learning}
\ccsdesc[300]{Computing methodologies~Neural networks}
\end{CCSCONCEPTSTEST}

\keywords{molecular property prediction, graph neural networks, context conditioning, drug discovery, virtual screening, FiLM, multi-task learning}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.95\columnwidth]{figures/fig1_architecture.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.95\columnwidth]{figures/fig3_attribution.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.95\columnwidth]{figures/fig4_dmta.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.95\columnwidth]{figures/fig_appendix.pdf}
...
\textbf{Molecular Featurization.} We convert SMILES strings to molecular graphs using RDKit \cite{landrum_rdkit}. Atom features (70-dim) include:
